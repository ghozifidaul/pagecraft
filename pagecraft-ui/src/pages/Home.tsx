...
function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div
        aria-hidden
        className="absolute inset-0 bg-[radial-gradient(circle,rgba(22,22,22,0.07)_1.5px,transparent_1.5px)] bg-size-[22px_22px] pointer-events-none"
      />
      <section className="relative mx-auto max-w-5xl px-6 py-20 sm:py-28 flex flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-xl text-[15px] sm:text-[17px] font-medium text-gray-800">
          Generate illustrated children's stories with a prompt, then refine
          each page until it's exactly how you imagined it.
        </p>
